...
kiemTraBanHayDaGuiYeuCauKetBan(user: any): string {
  ...
  console.log('this.userIdNguoiDungHienTai:', this.userIdNguoiDungHienTai);
  console.log('friends:', user?.friends);
  console.log('friendRequestsReceived:', user?.friendRequestsReceived);
  console.log('requestfriends:', user?.requestfriends);
  ...
  console.log('Trạng thái kết bạn là:', status);
