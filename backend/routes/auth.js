  ...
  try {
    ...
    const mailOptions = {
      ...
      html: `
        ...
        <a href="https://chat.fff3l.click/api/auth/verify?token=${encodeURIComponent(token)}">Xác thực tài khoản</a>
      `,
    };
  ...
  try {
    ...
    const mailOptions = {
      ...
      html: `
        ...
        <a href="https://chat.fff3l.click/api/auth/verify-reset-password?token=${token}&room=${roomId}">Đặt lại mật khẩu</a>
      `,
    };
